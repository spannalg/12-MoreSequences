...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         ...
         and Luke Spannan.
         Help received from CSSE 120 students Zane Blair and James Werne
...
def run_test_make_simple_string():
    ...
    print('Expected: 5-6-7-8-9-10-11-12-13-')
    print('Actual:', make_simple_string(5, 13))

    print('Expected: 7-8-9-10-11-')
    print('Actual:', make_simple_string(7, 11))
...
def run_test_make_less_simple_string():
    ...
    print('Expected: 5-6-7-8-9-10-11-12-13')
    print('Actual:', make_less_simple_string(5, 13))
    print('Expected: 7-8-9-10-11-12-13-14-15')
    print('Actual:', make_less_simple_string(7 ,15))
